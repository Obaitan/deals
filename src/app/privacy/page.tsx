      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="prose prose-lg text-gray-600">
          <p className="lead text-xl text-gray-800 mb-8">
            Your privacy is important to us. It is Afonja Deals' policy to
            respect your privacy regarding any information we may collect from
            you across our website.
          </p>

          <h3 className="text-gray-900 font-bold mt-8 mb-4">
          ...
          <p>
            ...
            website, send you newsletters (if you subscribe), and improve your
            user experience.
          </p>

          <h3 className="text-gray-900 font-bold mt-8 mb-4">3. Cookies</h3>
          <p>
            We use cookies to help us identify and track visitors, their usage
            of our website, and their website access preferences.
          </p>
          ...
          <p>
            ...
            user data, please contact us at hello@afonjadeals.com.
          </p>
