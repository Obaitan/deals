      ...
      <main className="flex-1">
        ...
        <div className="bg-emerald-50 border-b">
          <div className="container mx-auto px-4 py-12 flex flex-col items-center text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">{store.name} Coupons & Deals</h1>
            <p className="text-gray-500 max-w-lg">
              Save big at {store.name} with our verified promo codes and latest product deals.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          {/* Coupons Section */}
          <div className="mb-16">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Active Coupons for {store.name}</h2>
            {coupons.length > 0 ? (
          ...
          {/* Products Section */}
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-6">Top Deals from {store.name}</h2>
            {products.length > 0 ? (
