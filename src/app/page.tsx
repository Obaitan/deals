...
export default function Home() {
  ...
  return (
    <main className="flex-1">
      {/* Hero Section */}
      <section className="relative bg-emerald-900 text-white py-20 px-6 md:px-10 overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          <p className="text-emerald-100 text-lg md:text-xl mb-10 max-w-2xl mx-auto">
            Save money on electronics, fashion, phones, and more from your
            favorite stores like Jumia, Konga, and AliExpress.
          </p>
          ...
          <div className="bg-white p-2 rounded-full shadow-xl max-w-2xl mx-auto flex items-center">
            ...
            <Button
              size="lg"
              className="rounded-full bg-emerald-600 hover:bg-emerald-700 px-8 h-12 text-base"
            >
              Search
            </Button>
          </div>
